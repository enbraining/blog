/**
 * Dynamic OG image for the site root: 1200x630 PNG with name + description + avatar.
 * Runs on Edge (required by next/og ImageResponse). Used when sharing the homepage link.
 */
...
/** Load custom fonts for OG image text; paths relative to project root */
